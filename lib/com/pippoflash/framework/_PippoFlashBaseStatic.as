...
// CLASS ///////////////////////////////////////////////////////////////////////////////////////
	public class _PippoFlashBaseStatic implements IPippoFlashEventDispatcher {
		// STATIC USER DEFINABLE //////////////////////////////////////////////////////
		protected static var _mainApp				:_PippoFlashBase; // Reference to _mainApp - this should be _Application, but it would not work when this is used as a standalone plugin
