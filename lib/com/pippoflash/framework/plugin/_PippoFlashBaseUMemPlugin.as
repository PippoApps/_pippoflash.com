/* _PippoFlashBaseUMem - (c) Filippo Gregoretti - PippoFlash.com */
...
package com.pippoflash.framework.plugin {
	...
	import com.pippoflash.framework.interfaces.IUMem; 
	import com.pippoflash.utils.UCode; 
	import flash.display.MovieClip; 
	import flash.display.Sprite; 
	import flash.geom.Point;
	// DECLARATION /////////////////////////////////////////////////////////////////////////////
	public dynamic class _PippoFlashBaseUMemPlugin extends Sprite implements IUMem {
		// STATIC USER DEFINABLE //////////////////////////////////////////////////////
		public static var _mainApp:*; // Reference to MainApp
		public static var _config:*; // Reference to config file
		public static var _ref:*; // Reference to Ref()
		// STATIC SYSTEM 
...
// 		private static var _instancesById				:Object = {}; // This holds a direct reference to each instance by debug id
		...
		// INIT //////////////////////////////////////////////////////////////////////////////////////////
		public function _PippoFlashBaseUMemPlugin(id:String="_PippoFlashBaseUMemPlugin") {
...
// METHODS ///////////////////////////////////////////////////////////////////////////////////////
		...
		// MEMORY MANAGEMENT ///////////////////////////////////////////////////////////////////////////////////////
		/* IMPORTANT - Recycle is not set since number and type of parameters may change */
