...
// CLASS ///////////////////////////////////////////////////////////////////////////////////////
	public dynamic class _PippoFlashBaseNoDisplayPlugin implements IPippoFlashBase {
		...
		// DYNAMIC SYSTEM
		public var _debugPrefix					:String = "_PippoFlashBaseNoDisplayPlugin"; // Marks the ID of the item, good for initialization, text, and storage purposes
		protected var _pfId						:String = "_PippoFlashBaseNoDisplayPlugin";
		protected var _listeners					:Array; // List of listeners for each instance
		protected var _eventListeners				:Object;
// INIT //////////////////////////////////////////////////////////////////////////////////////////
		public function _PippoFlashBaseNoDisplayPlugin		(id:String, cl:Class=null) {
...
// STATIC METHODS ///////////////////////////////////////////////////////////////////////////////////////
		public static function callOnAll				(method:String, par:*=null):void {
			Debug.debug						("_PippoFlashBaseNoDisplayPlugin", "Calling on all classes:",method+"()");
...
// 			}
		...
		public static function callOn				(id:String, method:String, par:*=null):void {
			...
			else								Debug.debug("_PippoFlashBaseNoDisplayPlugin", "Cannot find instance",id,"can't call",method+"()");
		}
		public static function setInstanceXmlVariable		(node:XML):void { // Received from config as an xml variable
			...
			if (_instancesById[node.@instanceId]) {
				...
				Debug.error					("_PippoFlashBaseNoDisplayPlugin", "Cannot set instance variable: " + node.toXMLString());
			}
		}
		...
		public static function getClassById			(id:String):Class {
			if (!_classes[id])					Debug.error("_PippoFlashBaseNoDisplayPlugin", "Class " + id + " is not set in _classes.");
			return							_classes[id];
		}
		public static function getInstanceStatic		(id:String):_PippoFlashBaseNoDisplayPlugin {
...
// FRAMEWORK METHODS  ///////////////////////////////////////////////////////////////////////////////////////
	// Calls a standard pippoflash method, i.e. "MainApp.quit", calls the function quit() in instance MainApp
		public function callPippoFlashMethod			(method:String):* {
			...
			var instance						:_PippoFlashBaseNoDisplayPlugin = getInstance(a[0]);
...
// UTY ///////////////////////////////////////////////////////////////////////////////////////
// OOP METHODS ///////////////////////////////////////////////////////////////////////////////////////
		public function getInstance					(id:String):_PippoFlashBaseNoDisplayPlugin {
			return							_instancesById[id];
		}
