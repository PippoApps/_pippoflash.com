/* _PromptPlugin - Base class for all Prompts in plugin
...
package com.pippoflash.framework.plugin {
	...
	public dynamic class _PromptPlugin extends _Prompt {
		// STATIC SWITCHES ///////////////////////////////////////////////////////////////////////////////////////
		...
		//protected static var _blockingPrompt:_PromptPlugin; // Reference to the prompt which is blocking
		//protected static var _lastOpenedPrompt:_PromptPlugin; // The prompt that was last opened
		//protected static var _promptsChain:Vector.<_PromptPlugin> = new Vector.<_PromptPlugin>(); // Stores the sequence of opened prompts (when multiple prompts are opened)
...
// STATIC INIT (called by _Applicaiton init) ///////////////////////////////////////////////////////////////////////////////////////
		...
		//}
// INIT ////////////////////////////////////////////////////////////////////////////////////
		public function _PromptPlugin(id:String="_Prompt", group:String="default") {
			super(id, group);
			//_prompts.push(this);
	...
	// PLUGIN MANAGEMENT
		protected override function get mainApp():* { // This is overridden in _PromptPlugin. So that mainApp in plugin always returns plugin main app.
			// Since this is a plugin, I cannot convert local application to _Application
			...
			//protected function activateDragger(forceActivation:Boolean=false, draggerHeight:Number=0):* {
				...
				//if (_activateDragger || forceActivation) {
					...
					//if (!header) return Debug.warning(_debugPrefix, "Cannot activate dragger because _header sprite is not in prompt movieclip.")
...
// STATIC METHODS ///////////////////////////////////////////////////////////////////////////////////////
		...
		//public static function resetQueues():void { // Reset all queues waiting to be triggered
			//for each (var p:_PromptPlugin in _prompts) p.resetQueue(); // Close all prompts
		//}
		//public static function closeLastPrompt():void {
			//if (_lastOpenedPrompt) _lastOpenedPrompt.setOut();
		//}
		//public static function promptsAreBlocked(candidatePrompt:_PromptPlugin):Boolean { // Clears all prompts, removes queues, and clears all blockers
			//if (_blockingPrompt) {
		...
		//}
		//public static function getPrompt(id:String):_PromptPlugin {
		...
		//static public function activateManualCache():void { // This activates a prompt cache, so that they will all be sent once cache is removed
			//Debug.debug("_PromptPlugin", "Manual cache ACTIVE.");
		...
		//static public function removeManualCache(deleteCachedPrompts:Boolean=false):void { // This removes block, and triggers all cached prompts
			...
			//if (_manualQueue.length && _promptsChain.indexOf(_manualQueue[_manualQueue.length - 1].prompt) == -1)	{
				//Debug.debug("_PromptPlugin", "Manual cache DEACTIVATED. Triggering first prompt in queue. total prompts in queue: " + _manualQueue.length);
			...
			//}
			//else Debug.debug("_PromptPlugin", "Manual cache DEACTIVATED. No prompts in queue, or queued prompt is already visible (therefore cannot be launched).");
		//}
...
// METHODS ///////////////////////////////////////////////////////////////////////////////////////
		//public function restoreOnTop():void {
			...
			//if (addOnBottomOfOthers) { // Add below others
				...
				//parentContainer.addChildAt(this, parentContainer.getChildIndex(_promptsChain[0])); // Add below others, steal place to lowest prompt
			//}
			//// Just add on top 
			//else {
...
//// UTY /////////////////////////////////////////////////////////////////////////////////////////
		...
		//private function resetFunctions(animParam:_PromptPlugin=null):void { // Param is only needed because this can be launched at the end of a fade process
