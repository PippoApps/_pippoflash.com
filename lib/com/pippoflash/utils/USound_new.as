...
// METHODS ///////////////////////////////////////////////////////////////////////////////////////
	...
	// CONTROL SOUNDS
		...
		public static function stopAllSounds():void {
			disposeLoadedSound();
			for each (var j:* in _channels) j.stop();
		}
	...
	// SINGLE SOIUND VOLUME
		...
		// 	setSoundVolumePan(id, volume, (_channels[id].soundTransform as SoundTransform).volume);
		// }
		...
		// 	setSoundVolumePan(id, pan, (_channels[id].soundTransform as SoundTransform).pan);
		// }
		static public function setSoundVolumePan(id:String, volume:Number, pan:Number):* {
			...
			trace("CAZZOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO");
			...
			_channels[id].soundTransform.volume = 0.1;
			// (_channels[id] as SoundChannel).stop();
		}
	// GENERAL VOLUME
...
// 			Debug.debug						(_debugPrefix, "Set general volume (range is 0 to 1) to:",v);
		...
		public static function fadeGeneralVolumeTo(v:Number, fadeFrames:uint=30):void {
			if (getGeneralVolume()==v) return;
			doFadeVolumeTo(v, fadeFrames);
		}
	...
	// LOAD SOUND
		public static function loadSound(id:String, autoPlay:Boolean=true, listener:*=null):void {
			// trace("FREGNAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
...
// UTY ///////////////////////////////////////////////////////////////////////////////////////	
		...
		private static function doFadeVolumeTo(v:Number, framesDuration:uint=150, completeCallbackFunc:Function=null):void {
			...
			for (var i:uint=1; i<=FADE_SOUND_FRAMES; i++) {
